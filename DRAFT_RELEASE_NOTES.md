...
|----------|------------------------------------------------------|---------------|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Platform | Java                                                 | 17            | 21           | Upgraded to Java 21 LTS for improved performance, security, and access to latest language features. Updated all Docker images, CI/CD workflows, and build configurations.                                                                                |
