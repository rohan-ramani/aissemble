...
** You must add the executions/plugins to your `<project-name>-deploy/pom.xml` to activate it in your build. This will ensure the proper generation of deployment resources for your application.

* *Additions to the Helmfile*
** You must add the appropriate configurations to `helmfile.yaml.gotmpl` to enable deployment of your application. This will include the chart reference, namespace configuration, dependencies, and value file paths.


Be sure to add each artifact to the Helmfile and Deploy module as appropriate. Once completed, rerun the build with
[source,bash]
----
./mvnw clean install
----
...
=== [[k8s_profiles]]Available Profiles (Kubernetes)
[width="100%",options="header"]
|======
|Component                              | Profile                                  | ReadMe
|[[k8s_airflow]]Airflow                 | `airflow-deploy-v2`                      |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-airflow-chart/README.md[Airflow,role=external,window=_blank]
|Bias Detection                         | `bias-detection-deploy`                  |N/A
|Bias Detection Metrics Python Services | `bias-detection-metrics-python-services` |N/A
|Bill of Materials                      | `aissemble-bom-deploy`                   |N/A
...
|[[k8s_trino]]Data Access (Trino)       | `data-access-trino-deploy-v2`            |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-trino-chart/README.md[Trino,role=external,window=_blank]
|[[k8s_es]]ElasticSearch                | `elasticsearch-deploy-v2`                |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-elasticsearch-chart/README.md[ElasticSearch,role=external,window=_blank]
|ElasticSearch Operator                 | `elasticsearch-operator-deploy-v2`       |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-elasticsearch-operator-chart/README.md[ElasticSearch Operator,role=external,window=_blank]
|[[k8s_infer]]Inference                 | `inference-deploy-v2`                    |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-inference-chart/README.md[Inference,role=external,window=_blank]
|[[k8s_kafka]]Kafka                     | `kafka-deploy-v2`                        |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-kafka-chart/README.md[Kafka,role=external,window=_blank]
|[[k8s_kafka_conn]]Kafka Connect        | `kafka-connect-deploy`                   |N/A
|[[k8s_keycloak]]Keycloak               | `keycloak-deploy-v2`                     |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-keycloak-chart/README.md[Keycloak,role=external,window=_blank]
...
|[[k8s_metadata]]Metadata               | `metadata-deploy-v2`                     |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-metadata-chart/README.md[Metadata,role=external,window=_blank]
|[[k8s_mlflow]]MLflow                   | `mlflow-deploy-v2`                       |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-mlflow-chart/README.md[MLFlow,role=external,window=_blank]
|Model Training API                     | `training-deploy`                        |N/A
|Neo4j                                  | `neo4j-deploy`                           |N/A
|Nexus                                  | `nexus-deploy`                           |N/A
...
|[[k8s_pdp]]Policy Decision Point       | `policy-decision-point-deploy-v2`        |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-policy-decision-point-chart/README.md[Policy Decision Point,role=external,window=_blank]
|Postgres                               | `postgres-deploy`                        |N/A
|[[k8s_quarkus]]Quarkus                 | `quarkus-deploy-v2`                      |https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-quarkus-chart/README.md[Quarkus,role=external,window=_blank]
...
|[[k8s_inf]]aiSSEMBLE Infrastructure  | https://github.com/boozallen/aissemble/blob/{git-tree}/extensions/extensions-helm/aissemble-infrastructure-chart/README.md[aiSSEMBLE Infrastructure,role=external,window=_blank]
|======
...
==== Available V2 Upgrades
[width="100%",options="header"]
|======
|Old Profile                             | New Profile
|aissemble-airflow-deploy                |<<k8s_airflow,airflow-deploy-v2>>
|aissemble-mlflow-deploy                 |<<k8s_mlflow,mlflow-deploy-v2>>
...
|inference-deploy                        |<<k8s_infer,inference-deploy-v2>>
|jenkins-deploy                          |N/A, use <<k8s_inf,aiSSEMBLE Infrastructure>> directly
|kafka-deploy                            |<<k8s_kafka,kafka-deploy-v2>>
|kafka-connect-deploy                    |<<k8s_kafka_conn,kafka-connect-deploy-v2>>
|keycloak-deploy                         |<<k8s_keycloak,keycloak-deploy-v2>>
|metadata-deploy                         |<<k8s_metadata,metadata-deploy-v2>>
|s3local-deploy                          |<<k8s_s3,s3local-deploy-v2>>
|versioning-deploy                       |<<k8s_versioning,versioning-deploy-v2>>
|======
