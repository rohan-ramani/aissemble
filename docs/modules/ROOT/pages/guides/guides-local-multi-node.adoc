...
Now that you've configured your Node Affinity rules and labeled your node(s), you can run `helmfile apply` from the root
...
If you haven't already, run `helmfile apply` from the root directory of your project. After a few seconds, 5 pods should be
