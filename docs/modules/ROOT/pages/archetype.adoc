...
| ``organizationName``
| The name of the organization to use in the project
| Defaults to "Booz Allen Hamilton Inc." and can be updated in the `<organization>` section of the root `pom.xml`
|
| No
